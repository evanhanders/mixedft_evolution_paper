...
\caption{ 
	...
	Note that the coefficient resolution of the evolved FT simulation and the TT-to-FT simulation are the same (nz, nx) = (1024, 2048).
}
\vspace{-0.25cm}
...
\footnote{At these parameters, we would be in the cellular convection regime of \citet{stellmach&all2014}, but our dynamics are different due to our choice of stress free boundary conditions.
}.
