...
%Need to talk about: FF/TT differences in flow morphologies (aspect ratio) near onset. FT looks more like TT
%Need to add something like this after that statement:\ea{Indeed, \citet{calkins&all2015} have found a dynamical equivalence between FF and TT boundaries in rapidly rotating RBC.}
It is generally assumed that FT and FF boundaries should fundamentally behave similarly \ea{in their statistically stationary states} \cite{goluskin2016}, and the behavior of FF boundaries is well-known \cite{otero&all2002, johnston&doering2009}.
...
\qquad
\frac{dE}{dt} = -\iiint \grad\cdot F_{\text{cond}}\,dx\,dy\,dz = -\Gamma^^22 F_{\text{cond,z}}\bigg|_{z=-0.5}^{z=0.5}
\end{equation}
...
However, it is reasonable to assume that the evolutionary timescale lies within the window $\tau_{\text{th, FT-classical}} \in [\sqrt{\text{Ra Pr}} \,\text{Nu}^{-1}, \sqrt{\text{Ra Pr}}]$.
...
\ea{
\subsection{Nu-based initial conditions: rapid equilibration in \RB convection}
\label{sec:time_evolution_classic_ICs}

}


\subsection{TT-to-FT: arbitrary rapidly equilibrated FT simulations}
\label{sec:tt-to-ft}
...
\hline																	
Quantity 				&	BCs	& ICs	    &	$\mu$					&	$\sigma$				&	Skewness	&	Kurtosis \\
\hline
$T/\Delta T$			&	TT	& Classic	&	$5.00 \times 10^{-1}$	&	$7.11 \times 10^{-2}$	&	$-1.53 \times 10^{-2}$	&	$2.01 \times 10^{1}$ \\
						&	FT	& Classic	&	$5.07 \times 10^{-1}$	&	$7.37 \times 10^{-2}$	&	$7.31 \times 10^{-1}$	&	$2.70 \times 10^{1}$ \\
						&	FT	& TT-to-FT	&	$5.08 \times 10^{-1}$	&	$7.34 \times 10^{-2}$	&	$7.18 \times 10^{-1}$	&	$2.70 \times 10^{1}$ \\
						&	FT	& Nu-based	&	$5.06 \times 10^{-1}$	&	$7.36 \times 10^{-2}$	&	$7.63 \times 10^{-1}$	&	$2.70 \times 10^{1}$ \\
\hline                                                                                                                      
...
\hline                                                                                                                      
$wT/(\Delta T)^{3/2}$	&	TT	& Classic	&	$1.46 \times 10^{-3}$	&	$1.63 \times 10^{-1}$	&	$5.14 \times 10^{-2}$	&	3.06 \\
						&	FT	& Classic	&	$1.53 \times 10^{-3}$	&	$1.69 \times 10^{-1}$	&	$3.28 \times 10^{-2}$	&	2.92 \\
						&	FT	& TT-to-FT	&	$1.51 \times 10^{-3}$	&	$1.67 \times 10^{-1}$	&	$3.63 \times 10^{-2}$	&	3.13 \\
						&	FT	& Nu-based	&	$1.50 \times 10^{-3}$	&	$1.70 \times 10^{-1}$	&	$4.37 \times 10^{-2}$	&	3.20 \\
\hline                                                                                                                    
$w/(\Delta T)^{1/2}$ 	&	TT	& Classic	&	$-3.11 \times 10^{-5}$	&	$3.25 \times 10^{-1}$	&	$1.64 \times 10^{-2}$	&	2.99 \\
						&	FT	& Classic	&	$-3.80 \times 10^{-5}$	&	$3.33 \times 10^{-1}$	&	$1.75 \times 10^{-3}$	&	2.85 \\
						&	FT	& TT-to-FT	&	$2.66  \times 10^{-5}$	&	$3.29 \times 10^{-1}$	&	$-1.21 \times 10^{-3}$	&	3.08 \\
						&	FT	& Nu-based	&	$2.41  \times 10^{-5}$	&	$3.35 \times 10^{-1}$	&	$1.08 \times 10^{-2}$	&	3.14 \\
\hline																	
\end{tabular}
\end{center}
\end{table}
