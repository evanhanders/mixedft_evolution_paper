...
%why do we choose erf? why don't we specify a "right" bl shape?
...
The thermal energy reservoir of our 2D Cartesian systems, and the rate of change of this reservoir due to conduction at the boundaries, is
\begin{equation}
E = \iint T\,dx\,dz = \Gamma \int T\,dz,
\qquad
\frac{dE}{dt} = -\iint \grad\cdot F_{\text{cond}}\,dx\,dz = -\Gamma F_{\text{cond,z}}\bigg|_{z=-0.5}^{z=0.5}
\end{equation}
...
The magnitude of the temperature derivative achieved at the top boundary is initially very large ($|\partial_z T(z=0.5)|_{\text{early}} > \text{Nu}(t=\infty)$; see e.g., Fig.~1b in \cite{anders&all2018}), but monotonically decreases in magnitude throughout the evolution of a simulation, making it difficult to estimate the true thermal relaxation time.
