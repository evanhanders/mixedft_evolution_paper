...
When classic initial conditions which are in hydrostatic and thermal equilibrium are employed, the thermal relaxation of FT systems is very long compared to TT systems, in which it is nearly instantaneous.
...
We find that this long thermal relaxation can be bypassed by constructing smarter initial conditions based on the expected evolved value of Nu, or by simply using the results of TT simulations as initial conditions for FT simulations.
